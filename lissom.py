...
lgn_on_to_V1 = ConnetcionFieldProjection("LGNOnToV1",lgn_on,V1,0.5,0.0002,lgn_to_V1_kernel)
lgn_off_to_V1 = ConnetcionFieldProjection("LGNOffToV1",lgn_off,V1,0.5,0.0002,lgn_to_V1_kernel)
...
V1_lat_inh = ConvolutionalProjection("LateralInh",V1,V1,2.4*-3.45,0.0002,V1_lat_inh_kernel)
...
for i in xrange(10):
    ...
    lissom.run(0.04)
    applyHebianLearningStepOnAConnetcionFieldProjection(lgn_on_to_V1,0.1)
    applyHebianLearningStepOnAConnetcionFieldProjection(lgn_off_to_V1,0.1)
