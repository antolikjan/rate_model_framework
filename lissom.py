...
V1_lat_exc = ConvolutionalProjection(
    "LateralExc", V1, V1, 0.5 * float(STRENGTH_OF_CONNECTION), 0.001, center_lat
)
V1_lat_inh = ConvolutionalProjection(
    "LateralInh",
    V1,
    V1,
    -0.5 * float(STRENGTH_OF_CONNECTION) * float(0.01),
    0.001,
    surround_lat,
)
