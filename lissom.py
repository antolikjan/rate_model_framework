...
retina_to_lgn_on = FastConnetcionFieldProjection(
    "RetinaToLgnOn", retina, lgn_on, 1.0, 0.001, 0.375, on_weights
)
retina_to_lgn_off = FastConnetcionFieldProjection(
    "RetinaToLgnOff", retina, lgn_off, 1.0, 0.001, 0.375, off_weights
)

lgn_on_to_V1 = FastConnetcionFieldProjection(
    "LGNOnToV1",
    lgn_on,
    V1,
    0.5,
...
lgn_off_to_V1 = FastConnetcionFieldProjection(
    "LGNOffToV1",
    lgn_off,
    V1,
    0.5,
...
for i in range(run_for):
    ...
    lgn_on_to_V1.applyHebianLearningStep(0.0003)
    lgn_off_to_V1.applyHebianLearningStep(0.0003)
